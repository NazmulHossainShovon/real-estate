      ...
      <div className={`min-h-screen bg-gradient-to-br ${service.color.replace('to-', 'to-')} text-white`}>
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-teal-300 to-cyan-300 bg-clip-text text-transparent leading-tight">
              {service.title}
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto px-4">
              Premium tiles and sanitary solutions that combine functionality with 
              elegant design to enhance your living spaces.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-white/90 max-w-2xl">
                Our premium tiles and sanitary ware combine superior quality with 
                elegant designs to create beautiful, functional spaces.
              </p>
            </div>
          </div>
        </div>
