      ...
      <div className={`min-h-screen bg-gradient-to-br ${service.color.replace('to-', 'to-')} text-white`}>
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-blue-300 to-purple-300 bg-clip-text text-transparent leading-tight">
              {service.title}
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto px-4">
              Premium electronics and smart home solutions that blend innovation, 
              functionality, and modern design for your living spaces.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-white/90 max-w-2xl">
                Our premium electronics and smart home solutions combine 
                cutting-edge technology with exceptional quality to enhance your living experience.
              </p>
            </div>
          </div>
        </div>
