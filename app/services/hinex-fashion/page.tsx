      ...
      <div className={`min-h-screen bg-gradient-to-br ${service.color.replace('to-', 'to-')} text-white`}>
        <div className="container mx-auto px-6 py-16">
          ...
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 bg-gradient-to-r from-rose-300 to-pink-300 bg-clip-text text-transparent leading-tight">
              {service.title}
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-3xl mx-auto px-4">
              Experience luxury fashion that blends style, comfort, and 
              contemporary design to reflect your unique personality.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <p className="text-white/90 max-w-2xl">
                Our luxury fashion collections blend contemporary design with 
                premium materials to create pieces that reflect your unique style.
              </p>
            </div>
          </div>
        </div>
